...
const FeatureV2 = ({ sectionClass }: DataType) => {
            ...
            <div className={`feature-style-two-area ${sectionClass ? sectionClass : ""}`}>
                <div className="container">
                    <div className="feature-style-two-items">
                        <div className="feature-style-two info" style={{ backgroundImage: 'url(/assets/img/shape/15.png)' }}>
                            <div className="info">
                                ...
                                <div className="button">
                                    <Link onClick={() => setOpen(true)} to="#" className="popup-youtube text-play-button mt-20">
