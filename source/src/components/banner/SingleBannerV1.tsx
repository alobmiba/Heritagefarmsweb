...
const SingleBannerV1 = ({ banner }: { banner: DataType }) => {
    ...
    return (
        <>
            ...
            <div className="shape">
                <img src={`/assets/img/shape/${shape}`} alt="Image Not Found" />
            </div>
                        ...
                        <div className="content">
                            <div className="badge">
                                <div className="curve-text">
                                    ...
                                    <Link to="/services" className="popup-youtube">
                            ...
                            <div className="info">
                                ...
                                <div className="button">
                                    <Link className="btn btn-theme btn-md radius animation" to="/about-us">
                                        {buttonText}
                                    </Link>
                                </div>
                            </div>
