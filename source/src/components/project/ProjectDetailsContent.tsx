import projects8 from "/assets/img/projects/8.jpg";
import projects9 from "/assets/img/projects/9.jpg";
import projects10 from "/assets/img/projects/10.jpg";
                                    ...
                                    <div className="single-grid">
                                        <div className="item-grid-colum">
                                            ...
                                            <div className="right-info">
                                                ...
                                                <img src={projects8} alt="Image Not Found" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="single-grid">
                                    ...
                                    <div className="project-static-gallery">
                                        <div className="row">
                                            <div className="col-lg-6 col-md-6">
                                                <img src={projects9} alt="Thumb" />
                                            </div>
                                            <div className="col-lg-6 col-md-6">
                                                <img src={projects10} alt="Thumb" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
