...
import team1 from "/assets/img/farmers/1.jpg"
import team2 from "/assets/img/farmers/2.jpg"
                            ...
                            <div className="tab-pane fade" id="review-tab" role="tabpanel" aria-labelledby="review-tab-control">
                                ...
                                <div className="review-form">
                                    ...
                                    <div className="rating-select">
                                        <div className="stars">
                                            <span>
                                                <Link className="star-1" to="#" ><i className="fas fa-star" /></Link>
                                                <Link className="star-2" to="#" ><i className="fas fa-star" /></Link>
                                                <Link className="star-3" to="#" ><i className="fas fa-star" /></Link>
                                                <Link className="star-4" to="#" ><i className="fas fa-star" /></Link>
                                                <Link className="star-5" to="#" ><i className="fas fa-star" /></Link>
                                            </span>
                                        </div>
                                    </div>
                                    <ReviewForm />
